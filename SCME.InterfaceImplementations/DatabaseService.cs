...
namespace SCME.InterfaceImplementations
{
    public class DatabaseService : IDatabaseService
    {
        ...
        public static readonly Tuple<string, string, bool>[] _ConditionsList = SQLDatabaseService._mConditionsList;

        public static readonly Tuple<string, string, bool>[] _ParamsList = SQLDatabaseService._mParamsList;

        public static readonly Tuple<string, string, int>[] _DefectCodes = SQLDatabaseService._mDefectCodes;

        public static readonly Tuple<int, string>[] _TestTypes = SQLDatabaseService.m_TestTypes;
