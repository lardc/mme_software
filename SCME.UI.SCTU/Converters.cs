...
namespace SCME.UI
{
    public class SctuWaveFormTypeToParamVisibilityConverter : IValueConverter
    {
        public object Convert(object Value, Type TargetType, object Parameter, CultureInfo Culture)
        {
            var WaveFormType = (SctuWaveFormType)Value;

            if (WaveFormType == SctuWaveFormType.Trapezium)
        ...
        {
            throw new InvalidOperationException("ConvertBack method is not implemented in SctuWaveFormTypeToParamVisibilityConverter");
        }
    }
