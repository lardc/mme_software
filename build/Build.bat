...
"C:\Program Files (x86)\Microsoft Visual Studio\2019\BuildTools\MSBuild\Current\Bin\msbuild.exe" ..\SCME.DatabaseServer\SCME.DatabaseServer.csproj /restore /t:Rebuild /p:OutputPath="..\publish\Server" /p:Configuration=Debug /p:WarningLevel=0 
