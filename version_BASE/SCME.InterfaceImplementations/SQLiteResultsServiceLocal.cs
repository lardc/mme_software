...
namespace SCME.InterfaceImplementations
{
    public class SQLiteResultsServiceLocal : SQLiteResultsServiceServer
    {
        ...
        protected override long InsertDevice(ResultItem result, long groupId, Guid profileId)
        {
            ...
            var devInsertCommand = new SQLiteCommand("INSERT INTO DEVICES(DEV_ID, GROUP_ID, PROFILE_ID, CODE, SIL_N_1, SIL_N_2, TS, USR, POS, IsSendedToServer, MmeCode) VALUES(NULL, @GROUP_ID, @PROFILE_ID, @CODE, @SIL_N_1, @SIL_N_2, @TS, @USR, @POS, 0, @MmeCode)", _connection);
