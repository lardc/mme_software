...
namespace SCME.Logger
{
    public class ResultsJournal
    {
        ...
        public void Open(string databasePath, string databaseOptions, string mmeCode = null)
        {
            ...
            {
                var connectionString = string.Format("data source={0};{1}", databasePath, databaseOptions);
                ...
                _syncService = new SQLiteSyncService(connectionString, mmeCode);
        ...
        {
            _syncService.SyncResults();
            _syncService.SyncProfiles();
        }
