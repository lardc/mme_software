...
namespace SCME.Types
{
    ...
    public interface IExternalControl
    {
        ...
        bool Start(Gate.TestParameters ParametersGate, SL.TestParameters ParametersSL,
                   BVT.TestParameters ParametersBVT, Commutation.TestParameters ParametersCommutation, Clamping.TestParameters ParametersClamp);

        [OperationContract]
        [FaultContract(typeof (FaultData))]
        bool StartDynamic(TestParameters parametersCommutation, Clamping.TestParameters parametersClamp, Gate.TestParameters[] parametersGate, SL.TestParameters[] parametersVtm, BVT.TestParameters[] parametersBvt, dVdt.TestParameters[] parametersDvDt, SctuTestParameters[] parametersSctu);
