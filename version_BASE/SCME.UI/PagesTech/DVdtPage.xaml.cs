...
namespace SCME.UI.PagesTech
{
    ...
    public partial class DVdtPage : Page
    {
        ...
        public Types.Clamping.TestParameters ClamParameters { get; set; }
        ...
        public DVdtPage()
        {
            ClamParameters = new Types.Clamping.TestParameters
            {
        ...
        private void BtnStart_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (!Cache.Net.Start(commPar, ClamParameters, parameters))
                return;
            IsRunning = true;
        }
